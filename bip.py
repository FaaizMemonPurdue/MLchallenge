...
def train(src_folder:str, label_path, hard:bool = False):
    ...
    model.fit(X_train, tku.to_categorical(y_train, num_classes=num_classes), 
            batch_size=32, epochs=10, validation_split=0.2, callbacks=[checkpoint])
...
if __name__ == '__main__':
    ...
    train("../data/train_small", "purdue-face-recognition-challenge-2024/train_small.csv", hard=True)